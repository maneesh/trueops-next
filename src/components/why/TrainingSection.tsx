...
const TrainingSection = () => {
  return (
    <>
    <section className="w-full bg-[url('/images/trueOpsTrainingbg.jpg')] bg-cover bg-no-repeat bg-center py-10">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-10 lg:gap-80">
